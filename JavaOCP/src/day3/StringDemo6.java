...
public class StringDemo6 {
	...
	public static void main(String[] args) {
		...
		*/
		String marketData = """
				2026/02/07 14:30,台積,960.50,960.00,965.00,+2.35,1234567
				2026/02/07 14:31,聯發,1248.50,1245.00,1252.00,-1.25,456789
				2026/02/07 14:32,鴻海,185.25,184.50,186.00,+0.82,3456789
				""";
		...
		for(int i=0;i<lines.length;i++) {
			...
			System.out.printf("%-12s %-4s $%6.1f $%6.1f $%6.1f $%+.2f %,10d%n",
